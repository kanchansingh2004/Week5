package com.practiceproblems.filterrecords;
//Import packages
...
public class FilterRecords {
    public static void main(String[] args) {
        try {
            ...
            String jsonArray = "["
                    + "{\"name\":\"Kanchan\", \"age\":22, \"subjects\":[\"Mathematics\", \"Computer Science\"]},"
                    + "{\"name\":\"JoJo\", \"age\":27, \"subjects\":[\"Physics\", \"Chemistry\"]},"
                    + "{\"name\":\"Pintu\", \"age\":30, \"subjects\":[\"Biology\", \"English\"]}"
                    + "]";
            ...
            //Print valid message for exception
