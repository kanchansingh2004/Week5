package com.advancecsvproblems.encryptdecrypt;
...
public class EncryptAndDecrypt {
    ...
    private static final SecretKey secretKey = new SecretKeySpec(ENCRYPTION_KEY.getBytes(), ALGORITHM);

    public static void main(String[] args) {
        String csvFilePath = "D:\\Training_Capgemini\\Week5\\Day1\\src\\main\\java\\com\\advancecsvproblems\\encryptdecrypt\\employees.csv";  // Input CSV path
        String encryptedCsvFilePath = "D:\\Training_Capgemini\\Week5\\Day1\\src\\main\\java\\com\\advancecsvproblems\\encryptdecrypt\\encrypted.csv";  // Encrypted CSV path
        String decryptedCsvFilePath = "D:\\Training_Capgemini\\Week5\\Day1\\src\\main\\java\\com\\advancecsvproblems\\encryptdecrypt\\decrypted.csv";  // Decrypted CSV path
    ...
    public static void writeEncryptedCSV(String inputFile, String outputFile) {
        try (BufferedReader br = new BufferedReader(new FileReader(inputFile));
            ...
            while ((line = br.readLine()) != null) {
                ...
                String encryptedSalary = encrypt(data[5]);  // Salary encryption

                // Write encrypted data to output CSV
                String[] encryptedData = {data[0], data[1], encryptedEmail, data[3], data[4], encryptedSalary};
    ...
    public static void readDecryptedCSV(String inputFile, String outputFile) {
        try (BufferedReader br = new BufferedReader(new FileReader(inputFile));
            ...
            while ((line = reader.readNext()) != null) {
                ...
                String decryptedSalary = decrypt(line[5]);

                // Write decrypted data to output CSV
                String[] decryptedData = {line[0], line[1], decryptedEmail, line[3], line[4], decryptedSalary};
