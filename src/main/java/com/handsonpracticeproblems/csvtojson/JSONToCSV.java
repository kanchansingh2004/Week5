package com.handsonpracticeproblems.csvtojson;
...
public class JSONToCSV {
    public static void main(String[] args) {
        String csvInputPath = "src/main/java/com/handsonpracticeproblems/csvtojson/data.csv";   // Input CSV file
        String jsonOutputPath = "src/main/java/com/handsonpracticeproblems/csvtojson/data.json"; // Output JSON file
