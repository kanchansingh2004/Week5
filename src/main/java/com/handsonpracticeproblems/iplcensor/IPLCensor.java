package com.handsonpracticeproblems.iplcensor;
...
public class IPLCensor {
    public static void main(String[] args) {
        String jsonInputPath = "src/main/java/com/handsonpracticeproblems/iplcensor/input.json";
        String jsonOutputPath = "src/main/java/com/handsonpracticeproblems/iplcensor/output.json";
        String csvInputPath = "src/main/java/com/handsonpracticeproblems/iplcensor/input.csv";
        String csvOutputPath = "src/main/java/com/handsonpracticeproblems/iplcensor/output.csv";
